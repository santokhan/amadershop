<template>
    <AppContainer class="py-12 lg:py-16">
        <h2 class="text-3xl lg:text-4xl font-semibold">Terms and Conditions</h2>
        <h5 class="text-xl font-semibold mt-2">Welcome to amadershop.online!</h5>
        <p class="text-lg mt-4">These terms and conditions outline the rules and regulations for the use of Amader Shop's
            Website, located at <a href="https://Amadershop.online/" class="text-main hover:underline">Amadershop.online</a>
        </p>
        <p class="text-lg mt-4">By accessing this website we assume you accept these terms and conditions. Do not continue
            to
            use amadershop.online if you do not agree to take all of the terms and conditions stated on this page.</p>
        <p class="text-lg mt-4">
            ...
            accordance with and subject to, prevailing law of bd. Any use of the above terminology or other words in the
            singular, plural, capitalization and/or he/she or they, are taken as interchangeable and therefore as referring
            to
            same.
        </p>
        <h3 class="text-3xl font-semibold mt-8">Cookies</h3>
        <p class="text-lg mt-4">
            We employ the use of cookies. By accessing amadershop.online, you agreed to use cookies in agreement with the
            Amader
        ...
        <h3 class="text-3xl font-semibold mt-8">License</h3>
        <p class="text-lg mt-4">
            Unless otherwise stated, Amader Shop and/or its licensors own the intellectual property rights for all material
            on
            amadershop.online. All intellectual property rights are reserved. You may access this from amadershop.online for
            your
            own personal use subjected to restrictions set in these terms and conditions.
        </p>
        <h3 class="text-3xl font-semibold mt-8">You must not:</h3>
        <p class="text-lg mt-4">
            Republish material from amadershop.online
            Sell, rent or sub-license material from amadershop.online
            Reproduce, duplicate or copy material from amadershop.online
            Redistribute content from amadershop.online
        ...
        <p class="text-lg mt-4">
            ...
            areas
            of the website. Amader Shop does not filter, edit, publish or review Comments prior to their presence on the
            website. Comments do not reflect the views and opinions of Amader Shop,its agents and/or affiliates. Comments
            reflect the views and opinions of the person who post their views and opinions. To the extent permitted by
            applicable laws, Amader Shop shall not be liable for the Comments or for any liability, damages or expenses
            caused
            and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.
        </p>
        <p class="text-lg mt-4">
            Amader Shop reserves the right to monitor all Comments and to remove any Comments which can be considered
            inappropriate, offensive or causes breach of these Terms and Conditions.
        </p>
        <h3 class="text-3xl font-semibold mt-8">You warrant and represent that:</h3>
        <p class="text-lg mt-4">
            ...
            unlawful
            activity.
            You hereby grant Amader Shop a non-exclusive license to use, reproduce, edit and authorize others to use,
            reproduce
            and edit any of your Comments in any and all forms, formats or media.
        </p>

        <h3 class="text-3xl font-semibold mt-8">Hyperlinking to our Content</h3>
        <p class="text-lg mt-4">
        ...
        <h3 class="text-3xl font-semibold mt-8">We may consider and approve other link requests from the following types of
            organizations:</h3>
        <p class="text-lg mt-4">
            ...
            records
            with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of Amader Shop; and
            (d)
        ...
        <p class="text-lg mt-4">
            ...
            you
            must inform us by sending an e-mail to Amader Shop. Please include your name, your organization name, contact
        ...
        <h3 class="text-3xl font-semibold mt-8">Approved organizations may hyperlink to our Website as follows:</h3>
        <ul>
            <li>
            ...
            <li>
                No use of Amader Shop's logo or other artwork will be allowed for linking absent a trademark license
                agreement.
            </li>
        </ul>

        <h3 class="text-3xl font-semibold mt-8">iFrames</h3>
        ...
        <h3 class="text-3xl font-semibold mt-8"> Content Liability</h3>
        <p class="text-lg mt-4">
        ...
        <h3 class="text-3xl font-semibold mt-8">Reservation of Rights</h3>
        <p class="text-lg mt-4">
        ...
        <h3 class="text-3xl font-semibold mt-8">Removal of links from our website</h3>
        <p class="text-lg mt-4">
        ...
        <p class="text-lg mt-4">
            Disclaimer To the maximum extent permitted by applicable law, we exclude all representations, warranties and
