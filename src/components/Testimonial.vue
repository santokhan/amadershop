            ...
            <figure class="max-w-screen-md mx-auto">
                ...
                <blockquote>
                    <p class="text-2xl font-medium text-gray-900">
                        ...
                        components and pages starting from login screen to complex dashboard. Perfect choice for your next
                        SaaS application."
                    </p>
                </blockquote>
                <figcaption class="flex items-center justify-center mt-6 space-x-3">
                    ...
                    <div class="flex items-center divide-x-2 divide-gray-500">
                        <div class="pr-3 font-medium text-gray-900">Mishat</div>
                        <div class="pl-3 text-sm font-light text-gray-500">CEO at Amadershop</div>
                    </div>
                </figcaption>
            </figure>
        </div>
